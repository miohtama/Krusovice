define("krusovice/three/canvas", ['thirdparty/Three'], function(THREE) {
'use strict';
/**
...
THREE.CanvasRenderer = function ( parameters ) {
    ...
    this.render = function ( scene, camera ) {
        ...
        for ( e = 0, el = _renderList.length; e < el; e++ ) {
            ...
            if ( element instanceof THREE.RenderableParticle ) {
                ...
                if ( element.overdraw ) {
                    ...
                    expand2( _v1.positionScreen, _v2.positionScreen, _v1.expandX, _v1.expandY, _v2.expandX, _v2.expandY );
                    expand2( _v2.positionScreen, _v4.positionScreen, _v2.expandX, _v2.expandY, _v4.expandX, _v4.expandY );
                    expand2( _v4.positionScreen, _v1.positionScreen, _v4.expandX, _v4.expandY, _v1.expandX, _v1.expandY );

                    expand2( _v3.positionScreen, _v5.positionScreen, _v3.expandX, _v3.expandY, _v5.expandX, _v5.expandY );
                    expand2( _v3.positionScreen, _v6.positionScreen, _v3.expandX, _v3.expandY, _v6.expandX, _v6.expandY );
                }
        ...
        */
        ...
        function expand2( v1, v2, v1ex, v1ey, v2ex, v2ey ) {
            ...
            x *= idet; y *= idet;
            if(v2ex !== false) v2.x += x;
            if(v2ey !== false) v2.y += y;
            if(v1ex !== false) v1.x -= x;
            if(v1ey !== false) v1.y -= y;
