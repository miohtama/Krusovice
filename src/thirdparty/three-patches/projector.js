/*global define*/
define("krusovice/three/projector", ['krusovice/thirdparty/Three'], function(THREE) {
'use strict';
        ...
        for ( o = 0, ol = objects.length; o < ol; o++ ) {
            ...
            if ( object instanceof THREE.Mesh ) {
                ...
                for ( v = 0, vl = vertices.length; v < vl; v ++ ) {
                    ...
                    _vertex.expandX = vertices[ v ].expandX;
                    _vertex.expandY = vertices[ v ].expandY;
                ...
                for ( f = 0, fl = faces.length; f < fl; f ++ ) {
                    ...
                    if ( face instanceof THREE.Face3 ) {
                        ...
                        if ( v1.visible && v2.visible && v3.visible && v4.visible &&
                            ...
                            _face.v1.expandX = v1.expandX;
                            _face.v1.expandY = v1.expandY;
                            _face.v2.expandX = v2.expandX;
                            _face.v2.expandY = v2.expandY;
                            _face.v3.expandX = v3.expandX;
                            _face.v3.expandY = v3.expandY;
                            _face.v4.expandX = v4.expandX;
                            _face.v4.expandY = v4.expandY;
